...
_, thr1 = cv2.threshold(img, 127, 255, cv2.THRESH_BINARY) # in binary threshold, if image value in between threshoold if assign 0 else 1 to image  making it back and white image
